                ...
                <div class="header-menu">
                    <nav class="navbar">
                        <ul class="nav-ul">
                            ...
                            <li class="nav-li" @click="router.push('/juegos')"><p>Juegos</p></li>
                            <li class="nav-li" @click="router.push('/juegos')"><p>Ranking</p></li>
                            <li class="nav-li" @click="router.push('/equipos')"><p>Equipos</p></li>
                        </ul>
                    </nav>
                </div>
            </div>
